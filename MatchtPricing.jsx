...
const C = {
  ...
  amber:"#C9870C",amberDim:"#C9870C14",red:"#C0392B",purple:"#6B5EA8",purpleDim:"#6B5EA814",
  white2:"#FAFCFD",
};
...
function Check({color=C.green}){return <span style={{color,fontWeight:700,fontSize:15,flexShrink:0}}>✓</span>;}
function Dash(){return <span style={{color:C.gray400,fontSize:15,flexShrink:0}}>—</span>;}

function PlanCard({name,price,annualPrice,annual,badge,badgeColor=C.teal,highlight,sub,features,cta,ctaSecondary,note}){
  ...
  return (
    <div style={{
      ...
      <button style={{width:"100%",padding:"11px 0",borderRadius:8,background:highlight?C.teal:C.tealDim,color:highlight?C.white:C.teal,border:"none",fontWeight:700,fontSize:14,cursor:"pointer",fontFamily:F}}>{cta}</button>
      {ctaSecondary && <button style={{width:"100%",padding:"9px 0",borderRadius:8,background:"none",color:C.gray600,border:`1.5px solid ${C.border}`,fontWeight:600,fontSize:13,cursor:"pointer",fontFamily:F,marginTop:8}}>{ctaSecondary}</button>}
      {note && <p style={{fontSize:11,color:C.gray400,textAlign:"center",margin:"10px 0 0",fontFamily:F}}>{note}</p>}
    </div>
  );
}

function AddonCard({icon,name,price,trigger,desc,highlight}){
  return (
...
export default function App(){
  ...
  const recruiterPlans = [
    {
      ...
      features:[
        [true,"5 active job postings"],
        [true,"Unlimited candidate views"],
        [true,"Ranked candidate list"],
        [true,"Video profile access"],
        [true,"Accept / pass with feedback"],
        [true,"Basic match score breakdown"],
        [true,"Email notifications"],
        [false,"Smart filters"],
        [false,"Advanced analytics"],
        [false,"Company branding page"],
      ],
    ...
    {
      name:"Growth",
      price:179, annualPrice:139,
      sub:"For growing teams hiring regularly.",
      badge:"Most popular", badgeColor:C.teal, highlight:true,
      features:[
        [true,"15 active job postings"],
        [true,"Everything in Starter"],
        [true,"Smart filters (skill, salary, location, exp)"],
        [true,"Candidate messaging"],
        [true,"Analytics dashboard"],
        [true,"Scoring weight adjustments per role"],
        [true,"Company branding page"],
        [false,"Executive talent pool access"],
        [false,"Multi-user / team seats"],
        [false,"API access"],
      ],
      cta:"Start free trial",
      note:"14-day free trial. No card required.",
    ...
    {
      name:"Pro",
      price:299, annualPrice:239,
      sub:"For established orgs with volume hiring needs.",
      badge:null, highlight:false,
      features:[
        [true,"25 active job postings"],
        [true,"Everything in Growth"],
        [true,"Early access to top-matching candidates"],
        [true,"Priority candidate notifications"],
        [true,"Advanced analytics + export"],
        [true,"3 team seats included"],
        [true,"Dedicated onboarding support"],
        [false,"Executive talent pool access"],
        [false,"Unlimited team seats"],
        [false,"API access"],
      ],
      cta:"Start free trial",
      note:"14-day free trial. No card required.",
    ...
    {
      name:"Executive",
      price:499, annualPrice:399,
      sub:"For VP+ and C-suite hiring. Separate, higher-quality talent pool.",
      badge:"High-value roles", badgeColor:C.purple, highlight:false,
      features:[
        [true,"10 active executive postings"],
        [true,"Access to executive candidate pool (VP+)"],
        [true,"Everything in Pro"],
        [true,"White-glove onboarding"],
        [true,"Dedicated account manager"],
        [true,"Candidate background verification add-on"],
        [true,"5 team seats included"],
        [false,"Unlimited postings"],
    ...
    {
      name:"Agency",
      price:1999, annualPrice:1599,
      sub:"For staffing agencies managing multiple clients and high-volume roles.",
      badge:null, highlight:false,
      features:[
        [true,"Unlimited active job postings"],
        [true,"Multi-client management dashboard"],
        [true,"Everything in Executive"],
        [true,"Unlimited team seats"],
        [true,"API access"],
        [true,"White-label option"],
        [true,"Dedicated support + SLA"],
        [true,"Custom analytics reporting"],
  ...
  const seekerAddons = [
    {
      ...
      price:"$9.99",
      trigger:"Skills don't match",
      desc:"A detailed breakdown of which skills are getting you passed on most, what roles you'd score higher on, and specific steps to close the gap.",
      highlight:true,
    },
    {
      icon:"💰",
      ...
      price:"$4.99",
      trigger:"Salary expectations too high",
      desc:"See where your salary expectations sit vs. current market rates for your title, experience level, and location. Includes a recommended range.",
    },
    {
      icon:"📄",
      name:"Profile & Resume Review",
      price:"$79",
      trigger:"Education background / experience",
      desc:"A human recruiter reviews your full profile, answers, and video intro. You get written feedback and specific recommendations within 48 hours.",
    },
    {
      icon:"🧠",
      name:"Personality & Culture Coaching",
      price:"$79",
      trigger:"Culture / work style mismatch",
      desc:"A coach reviews your behavioral and personality answers and gives honest feedback on how your responses are coming across to employers — and how to adjust.",
    },
    {
      icon:"🚀",
      name:"Profile Boost",
      price:"$4.99",
      trigger:"Any rejection / low visibility",
      desc:"Moves your profile to the top of recruiter search results for 48 hours. Useful when you're early in your job search or haven't been getting many views.",
    },
    {
      icon:"💬",
      name:"Unlock Full Feedback",
      price:"$2.99",
      trigger:"Any rejection",
      desc:"You always see the rejection category for free. Pay to unlock the recruiter's specific notes and any additional context they chose to share.",
    },
    {
      icon:"🎥",
      name:"Video Review",
      price:"$49",
      trigger:"Multiple passes / low callback rate",
      desc:"A recruiter watches your video intro and gives you actionable feedback on your delivery, content, and how to make a stronger first impression.",
    },
    {
      icon:"📊",
      name:"Match Score Audit",
      price:"$14.99",
      trigger:"Consistently low match scores",
      desc:"A detailed review of why your profile is scoring low across specific dimensions, with a prioritized action plan to improve your overall match percentage.",
    },
  ];
  ...
  const recruiterAddons = [
    ...
    { icon:"📌", name:"Featured Job Post", price:"$49/post", desc:"Your role appears at the top of the matched candidate's job feed for 7 days, increasing visibility and application rate." },
  ...
  return (
    <div style={{fontFamily:F,background:C.bg,minHeight:"100vh",paddingBottom:80}}>
      ...
      {/* Nav */}
      <div style={{background:C.white,borderBottom:`1px solid ${C.border}`,padding:"0 28px",height:54,display:"flex",alignItems:"center",gap:8}}>
        <div style={{width:26,height:26,borderRadius:6,background:C.teal,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800,fontSize:11,color:C.white}}>M</div>
        <span style={{fontWeight:800,fontSize:15,color:C.slate,letterSpacing:-0.3}}>Matcht</span>
        <span style={{fontSize:12,color:C.gray400,marginLeft:4}}>/ Pricing</span>
      </div>

      {/* Hero */}
      <div style={{textAlign:"center",padding:"56px 24px 40px"}}>
        <h1 style={{fontSize:"clamp(30px,5vw,48px)",fontWeight:800,color:C.slate,letterSpacing:-1.5,margin:"0 0 12px",fontFamily:F}}>
        ...
        <div style={{display:"inline-flex",background:C.white,border:`1px solid ${C.border}`,borderRadius:10,padding:4,gap:4,marginBottom:28}}>
          {[["seeker","For Job Seekers"],["recruiter","For Recruiters"]].map(([k,l])=>(
            <button key={k} onClick={()=>setTab(k)} style={{padding:"9px 22px",borderRadius:7,background:tab===k?C.teal:"none",color:tab===k?C.white:C.gray600,border:"none",fontWeight:700,fontSize:14,cursor:"pointer",fontFamily:F,transition:"all .18s"}}>{l}</button>
          ))}
        </div>
        ...
        {tab==="recruiter" && (
          <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:10}}>
            ...
            <div onClick={()=>setAnnual(a=>!a)} style={{width:44,height:24,borderRadius:12,background:annual?C.teal:C.gray200,cursor:"pointer",position:"relative",transition:"background .2s"}}>
      ...
      {tab==="seeker" && (
        <div style={{maxWidth:980,margin:"0 auto",padding:"0 20px"}}>
          ...
          <div style={{background:C.teal,borderRadius:16,padding:"36px 40px",display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:40,flexWrap:"wrap",gap:20}}>
            ...
            <button style={{background:C.white,color:C.teal,border:"none",borderRadius:10,padding:"13px 28px",fontWeight:800,fontSize:15,cursor:"pointer",fontFamily:F,flexShrink:0}}>Create free profile →</button>
          </div>
      ...
      {tab==="recruiter" && (
        <div style={{maxWidth:1100,margin:"0 auto",padding:"0 20px"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))",gap:14,marginBottom:48}}>
            {recruiterPlans.map(p=><PlanCard key={p.name} {...p} annual={annual}/>)}
          </div>
          ...
          <div style={{background:C.slate,borderRadius:16,padding:"32px 36px",display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:48,flexWrap:"wrap",gap:20}}>
            ...
            <button style={{background:C.teal,color:C.white,border:"none",borderRadius:9,padding:"12px 24px",fontWeight:700,fontSize:14,cursor:"pointer",fontFamily:F,flexShrink:0}}>Talk to us →</button>
          </div>
