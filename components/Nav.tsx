...
export default function Nav() {
  ...
  // Never hide the nav — show a minimal shell while loading so users aren't blocked
  ...
  return (
    <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 28px', height: 56, background: C.white, borderBottom: `1px solid ${C.border}`, position: 'sticky', top: 0, zIndex: 100, fontFamily: F }}>
      <div onClick={() => router.push(profile ? (isRecruiter ? '/recruiter/jobs' : '/dashboard') : '/')} style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}>
